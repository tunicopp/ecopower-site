...
import ourMaterial from "../../../../public/assets/images/sustainability/our-materials.png";
import { MdPlayCircle } from "react-icons/md";
import cleanEnergy from "../../../../public/assets/images/sustainability/clean-energy.svg";
import climateChange from "../../../../public/assets/images/sustainability/climate-change.svg";
import healthWellBeing from "../../../../public/assets/images/sustainability/health-well-being.svg";
import qualityEducation from "../../../../public/assets/images/sustainability/quality-education.svg";
  ...
  return (
    <section className="bg-beige-300 py-[80px]">
      ...
      <GridContainer className="lg:flex-row flex-col items-center gap-6 mt-[70px]">
        ...
        <div className="flex flex-1 relative rounded-2xl">
          <Image
            src={ourMaterial}
            alt="Nossos materiais vídeo"
