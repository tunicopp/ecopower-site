...
const JoinUs: React.FC = () => {
  return (
    <section className="pb-[80px] lg:px-0 px-6">
      <GridContainer className="flex-col items-center justify-center bg-primary-green rounded-[20px] py-[80px] gap-6 relative overflow-hidden">
        <Image
          src={joinUsOne}
          alt="Junte-se à nós"
          className="absolute -left-[31px] -top-[18px] lg:w-auto md:w-[140px] w-[110px]"
        />
        <Image
          src={joinUsTwo}
          alt="Junte-se à nós"
        ...
        <Image
          src={joinUsFour}
          alt="Junte-se à nós"
          className="absolute md:-right-[62px] -right-[24px] md:-bottom-[31px] -bottom-[24px] lg:w-auto md:w-[200px] w-[100px]"
        />
        <Image
          src={cloud}
          alt="Nuvem"
        ...
        <Image
          src={houseOne}
          alt="Casa"
          className="absolute lg:left-[296px] md:left-[180px] left-[24px] lg:-bottom-[42px] md:-bottom-[32px] -bottom-[16px] lg:w-auto md:w-[72px] w-[48px]"
        />
        <Image
          src={houseTwo}
          alt="Casa"
          className="absolute lg:right-[245px] md:right-[40px] right-[90px] lg:-bottom-[42px] md:-bottom-[32px] -bottom-[16px] lg:w-auto md:w-[72px] w-[48px]"
        />
        <Image
          src={trees}
          alt="Árvores"
          className="absolute lg:right-[391px] md:right-[270px] right-[145px] lg:-bottom-[29px] md:-bottom-[12px] -bottom-1 lg:w-auto md:w-[20px] w-[10px]"
        />
        <Image
          src={panel}
          alt="Casa"
          className="absolute md:left-[50%] left-[25%] md:-translate-x-2/4 -bottom-1 md:w-auto w-[70px]"
        />
