  ...
  return (
    <>
      ...
      <div className="bg-white w-full p-10 rounded-b-3xl flex flex-col items-center">
        ...
        <a
          target="_blank"
          href="https://api.whatsapp.com/send?phone=5517992753678&text=Ol%C3%A1,%20acabei%20de%20simular%20meu%20projeto%20no%20site%20e%20quero%20mais%20informa%C3%A7%C3%B5es"
